        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-gray-700">View dashboard and basic features</span>
            </div>
            
            {user?.role === "admin" && (
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                <span className="text-gray-700">Manage users and view admin features</span>
              </div>
            )}
            ...
            {user?.role === "superadmin" && (
              <>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-700">Create users, change roles, and full system access</span>
                </div>
              </>
            )}
          </div>
          ...
          {(user?.role === "admin" || user?.role === "superadmin") && (
            <div className="mt-6">
              <Link
                to="/admin/users"
                className="inline-flex items-center space-x-2 bg-gradient-to-r from-blue-500 to-indigo-600 text-white px-6 py-3 rounded-lg font-semibold hover:from-blue-600 hover:to-indigo-700 transition-all duration-200 transform hover:scale-105"
              >
